...
export const Events = () => {
  return (
    <div className='text-1.5xl'>
      ...
      >
      <section className=' items-center grid grid-cols-3 p-4 text-7xl justify-center font-bold object-center text-center '> 
  < div className='justify-center p-4 '>
    
  <Image className=' transition duration-300 ease-in-out hover:scale-110 items-center object-fill h-96 w-96 rounded-2xl justify-center' src={ebsb} alt='team'  ></Image>
  </div>
          <div className='justify-center p-4 m-auto'>
  <Image className='transition duration-300 ease-in-out hover:scale-110 items-center object-fill h-96 w-96 rounded-2xl justify-center' src={lan} alt='Holid'  ></Image>
  </div>

          <div className='justify-center p-4 m-auto'>
  <Image className='transition duration-300 ease-in-out hover:scale-110 items-center object-fill h-96 w-88 rounded-2xl justify-center' src={holi} alt='Holi'  ></Image>
  </div>
          </section>
          </motion.div>
      ...
      >   
          <section className=' bg-yellow-50 p-4 m-auto grid grid-cols-2 gap-4 justify-center bg-color' >
           ...
           <p className='  p-10 text-neutral-900  text-justify m-auto indent-8 whitespace-normal flex justify-center items-center '>Bathukamma is a flower-festival celebrated by the women of Telangana and some parts of Andhra Pradesh  Students away from their homes often miss the festivities of the house. In our attempt to give the IITH campus a flavour of home, a diya decoration and rangoli making contest was organized near the mess where the students, faculty and staff showcased their artistic talents.Students away from their homes often miss the festivities of the house. In our attempt to give the IITH campus a flavour of home, a diya decoration and Bathukamma contest was organized near the mess where the students, faculty and staff showcased their artistic talents.</p>
             ...
             <div className='p-5 space-x-4   m-auto '>
             <Image className=' transition duration-300 ease-in-out hover:scale-110 p-4 rounded-3xl shadow-2xl justify-center w-96 h-88' src={sky} alt='Lohri_celebrations' />
           </div>
      ...
      >   
          <section className='  bg-gradient-to-r from-yellow-100 to-fuchsia-100  p-4 m-auto grid grid-cols-2 gap-4 justify-center bg-color' >
            
            <div className='p-5 m-auto space-x-5  '>
              <Image className=' transition duration-300 ease-in-out hover:scale-110 rounded-3xl outline-4 shadow-2xl justify-center w-96 h-88' src={d1} alt='Lohri_celebrations' />
            </div>
            <div className='p-4 space-x-4'>
...
..</p>
              ...
              <div className='p-5 space-x-4   m-auto '>
              <Image className=' transition duration-300 ease-in-out hover:scale-110 p-4 rounded-2xl shadow-2xl justify-center w-96 h-90' src={r1} alt='Lohri_celebrations' />
            </div>
...
<motion.div
      ...
      >   
         <section className='grid grid-rows-1 gap-4 space-x-4 justify-center p-4 m-auto bg-blue-50 '>
                         <div className='p-4 justify-center flex justify-between  '>
                             <Image className=' m-auto transition duration-300 ease-in-out hover:scale-110 rounded-3xl outline-4 shadow-2xl justify-center w-72 h-72' src={l1} alt='l1'></Image>
                             <Image className='m-auto transition duration-300 ease-in-out hover:scale-110 rounded-3xl outline-4 shadow-2xl justify-center w-72 h-72 ' src={s1} alt='l1'></Image>
                       </div>      
                       <div className='p-4 space-x-4 grid grid-rows-1 justify-center'>
              
              <p className=' text-justify p-4 text-neutral-900  text-justify m-auto indent-8 whitespace-normal flex justify-center items-center '>Lohri is a popular winter Punjabi folk festival celebrated primarily in Northern India. The significance and legends about the Lohri festival are many and these link the festival to the Punjab region. It is believed by many that the festival marks the passing of the winter solstice.
